...
🌐 **Live Demo:** [pesaninaja.vercel.app](https://pesaninaja.vercel.app)
...
1. Buka halaman repo ini: [github.com/juztrezky2/pesaninaja](https://github.com/juztrezky2/pesaninaja)
...
2. Klik **"New Project"**
3. Isi nama project, password database, dan pilih region (disarankan: **Southeast Asia - Singapore**)
4. Tunggu hingga project selesai dibuat (~1–2 menit)
...
2. Buka setiap file `.sql` di folder `supabase/migrations/` di repo ini
3. Copy-paste isinya ke SQL Editor, lalu klik **Run** (urutkan berdasarkan nama file / timestamp)
